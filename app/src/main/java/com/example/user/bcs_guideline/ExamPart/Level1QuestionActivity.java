...
public class
Level1QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Level1Question question = new Level1Question();
    ...
    private int nextRandom() {
      ...
      //  Log.d("TempQuestionArrayIndex", String.valueOf(ranInt));
       ...
       // tv_question.setText(question.getQuestion(ranInt));
     //   Log.d("tv_question", question.getQuestion(ranInt));

      //  btn_one.setText(question.getchoice1(ranInt));
      //  Log.d("btn_one",question.getchoice1(ranInt));
       // btn_two.setText(question.getchoice2(ranInt));
      //  Log.d("btn_two",question.getchoice2(ranInt));
       // btn_three.setText(question.getchoice3(ranInt));
      //  Log.d("btn_three",question.getchoice3(ranInt));
       // btn_four.setText(question.getchoice4(ranInt));
      //  Log.d("btn_four",question.getchoice4(ranInt));
      //  answer = question.getCorrectAnswer(ranInt);
    ...
    private void Wrong(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Level1QuestionActivity.this);
        alertDialogBuilder
                .setMessage("Wrong")
                .setCancelable(false)
                .setPositiveButton("Again", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(getApplicationContext(), Level1QuestionActivity.class));
                    }
                })
