...
public class Level5QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Level5Question question = new Level5Question();
    ...
    private int totoalQuestion=25;
    private String level="Level_5";
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Again", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(getApplicationContext(), Level5QuestionActivity.class));
                    }
                })
