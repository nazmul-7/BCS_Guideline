...
public class Level3QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Level3Question question = new Level3Question();
    ...
    private void Wrong(){
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Level3QuestionActivity.this);
        alertDialogBuilder
                .setMessage("Wrong")
                .setCancelable(false)
                .setPositiveButton("Again", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(getApplicationContext(), Level3QuestionActivity.class));
                    }
                })
