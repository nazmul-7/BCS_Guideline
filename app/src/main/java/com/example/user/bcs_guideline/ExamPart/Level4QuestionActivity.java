...
public class Level4QuestionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Level4Question question = new Level4Question();
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Again", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(getApplicationContext(), Level4QuestionActivity.class));
                    }
                })
